...
theory which we call the theory of signatures. The internal syntax of
the theory of signatures is given by a QIIT as well. Then, using this
internal syntax we show that all specified QIITs exist and they have a
dependent elimination principle. We also show that algebras of
a signature form a category with families (CwF) and use the internal
language of this CwF to show that dependent elimination is
...
\keywords{homotopy type theory, inductive-inductive types, higher inductive types, quotient inductive types, logical relations}  %% \keywords are mandatory in final camera-ready submission
...
how our method works for the above $\Con$-$\Ty$ example. % A more formal
% discussion of the metatheory and signatures will follow in Section
% \ref{sec:metatheory} and \ref{sec:signatures}.

%% Our notationn
%% for the metatheory is standard, but we summarise it in Section
%% \ref{sec:metatheory}.
